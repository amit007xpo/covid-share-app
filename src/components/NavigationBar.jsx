...
class NavigationBar extends Component {
  ...
  render() {
    ...
    <Navbar collapseOnSelect expand="lg" sticky="top" style={{backgroundColor:'transparent', color: 'white'}}>
        <Navbar.Brand href="#" onClick={this.goBackBtn} style={{color: 'white', backgroundColor: 'transparent', padding: '0 1rem'}}><img src="/public/media/back-icon.svg" alt="back_img"/> {locale.back[localeData]}</Navbar.Brand>
    </Navbar>
    );
  }
}
